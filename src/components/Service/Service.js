                                        ...
                                        <div className="col-lg-4 mobile-card" key={exp}>
                                            <div className="card card-shadow border-0 mb-4">
                                                <div className="row no-gutters">
                                                    <div className="col-md-3 col-3 pro-pic" style={{ backgroundImage: `url(${users.image === null || users.image === '' ? 'http://businessboosters.club/public/images/user_images/no_images.png' : baseURLurimg + users.image})`, backgroundPosition: 'center', backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }}>
                                                    </div>
